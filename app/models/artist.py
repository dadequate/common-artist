...
class Artist(Base):
    ...
    status:       Mapped[ArtistStatus] = mapped_column(Enum(ArtistStatus, native_enum=False), default=ArtistStatus.APPLICANT)
...
class Application(Base):
    ...
    status:        Mapped[ApplicationStatus] = mapped_column(Enum(ApplicationStatus, native_enum=False), default=ApplicationStatus.PENDING)
